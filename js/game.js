        ...
        handleClick: function (e) {
            ...
            if (e.target.classList.contains("cell")) {
                ...
                if (this.getPhase() === this.PHASE_INIT_PLAYER && ship.dom.parentNode) {
                   ...
                   //             var first = document.querySelector('*>select').value;
                    //            if (first === 'computer') {
                    //                self.phaseOrder = [
                     ...
                     //               }
                     //           }
                                document.querySelector('#selectFirstPlayer').style.display = 'none';
                                self.goNextPhase();
                            }, function () {
                                self.stopWaiting();
                                // sinon, on efface les bateaux et on recommence
