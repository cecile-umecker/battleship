(function (global) {
    ...
    global.utils = {
        ...
        sounds: {
            'fire': new Audio('sounds/fire_sound.mp3'),
            'hit': new Audio('sounds/hit_sound.mp3'),
            'hit_voice': new Audio('sounds/miss_advertise_sound.mp3'),
            'hit_voice2': new Audio('sounds/hit_advertise_sound.mp3'),
            'missed': new Audio('sounds/miss_sound.mp3')
        },
